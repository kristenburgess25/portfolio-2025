    ...
    <AboutContainer>
      ...
      <AboutIconsContainer container spacing={3} justifyContent="center">
        <IconContent item xs={12} sm={4} md={4} lg={4} xl={4}>
          ...
          <Typography variant="h5" sx={{ marginTop: 1, color: "#6A0572", fontFamily:"'Zain', serif", fontSize: "1.75rem" }}>Education</Typography>
        ...
        <IconContent item xs={12} sm={4} md={4} lg={4} xl={4}>
          ...
          <Typography variant="h6" sx={{ marginTop: 1, color: "#6A0572", fontFamily:"'Zain', serif", fontSize: "1.75rem" }}>Work</Typography>
          <Typography sx={{ color: "#333" }}>
          ...
          <Box sx={{ display: "flex" }}>
            <Link href="/projects">
              <Button sx={{color: "#6A0572", fontFamily:"'Zain', serif", fontSize: "1.25rem", margin: "0 1rem" }}>
                Projects
              </Button>
            </Link>
            <Link href="/projects">
        ...
        <IconContent item xs={12} sm={4} md={4} lg={4} xl={4}>
          ...
          <Typography variant="h6" sx={{ marginTop: 1, color: "#6A0572", fontFamily:"'Zain', serif", fontSize: "1.75rem" }}>Code</Typography>
          <Typography sx={{ color: "#333" }}>

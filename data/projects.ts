...
export const projects: Project[] = [
  {
    ...
    tags:['backend', 'frontend', 'fullstack', 'design', 'personal', 'featured'],
    subtags: [],
    featured: true,
    year: "2025",
  ...
  },
  {
    ...
    tags:['frontend', 'googlecloud', 'app', 'pro', 'ecomm'],
  ...
  },
  {
    ...
    screenshots: ["/logos/IT_stacked_logo_fullcolor.png"],
